...
$windows_install_lib="$windows_install_root/bin" # dear msvc i beseech you let this be the right directory
...
$sdl_mixer_flags=@('-DSDLMIXER_STRICT=ON','-DSDLMIXER_INSTALL_CPACK=OFF','-DSDLMIXER_INSTALL_MAN=OFF','-DSDLMIXER_DEPS_SHARED=OFF','-DSDLMIXER_VENDORED=ON','-DSDLMIXER_SAMPLES=OFF','-DSDLMIXER_FLAC=ON','-DSDLMIXER_MOD=OFF','-DSDLMIXER_MP3=ON','-DSDLMIXER_MIDI=ON','-DSDLMIXER_OPUS=ON','-DSDLMIXER_WAVPACK=OFF','-DSDLMIXER_INSTALL=ON')
$sdl_ttf_flags=@('-DSDLTTF_STRICT=ON','-DSDLTTF_INSTALL_CPACK=OFF','-DSDLTTF_INSTALL_MAN=OFF','-DSDLTTF_VENDORED=ON','-DSDLTTF_SAMPLES=OFF','-DSDLTTF_INSTALL=ON')
