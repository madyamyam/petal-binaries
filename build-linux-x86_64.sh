...
strip -S "$linux_install_root"/libSDL3.so
cp "$linux_install_root"/libSDL3.so $linux_bin_root/
...
strip "$linux_install_root"/libSDL3_image.so
cp "$linux_install_root"/libSDL3_image.so $linux_bin_root/
...
strip "$linux_install_root"/libSDL3_mixer.so
cp "$linux_install_root"/libSDL3_mixer.so $linux_bin_root/
...
strip "$linux_install_root"/libSDL3_ttf.so
cp "$linux_install_root"/libSDL3_ttf.so $linux_bin_root/
...
strip "$linux_install_root"/libSDL3_shadercross.so
cp "$linux_install_root"/libSDL3_shadercross.so $linux_bin_root/

strip "$linux_install_root"/libdxcompiler.so
cp "$linux_install_root"/libdxcompiler $linux_bin_root/

strip "$linux_install_root"/libdxil.so
cp "$linux_install_root"/libdxil.so $linux_bin_root/
